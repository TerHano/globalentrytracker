...
export interface paths {
    ...
    "/api/auth/v1/forgotPassword": {
         ...
         * @description Sends a password reset email to the user with the provided email address if it exists and is confirmed. The email contains a reset code and a link to reset the password. To reset the password, make a /resetPassword request with the email, reset code, and new password.
         */
    ...
    "/api/auth/v1/resetPassword": {
         ...
         * @description Resets the user's password using the provided reset code. To get a reset code, first make a /forgotPassword request with the user's email to receive the reset code in an email.
         */
